...
import com.example.islamiapp.adapter.VersesRecyclerAdapter;
...
public class SuraDetailsActivity extends AppCompatActivity {
    ...
    VersesRecyclerAdapter versesRecycleAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        versesRecycleAdapter = new VersesRecyclerAdapter(verses);
